...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const promoData = {
    best: [
      "../../assets/paket/Best/b1.jpg",
      "../../assets/paket/Best/b2.jpg",
      "../../assets/paket/Best/b3.jpg",
      "../../assets/paket/Best/b4.jpg",
      "../../assets/paket/Best/b5.jpg",
      "../../assets/paket/Best/b6.jpg",
      "../../assets/paket/Best/b7.jpg",
      "../../assets/paket/Best/b8.jpg",
      "../../assets/paket/Best/b9.jpg",
      "../../assets/paket/Best/b10.jpg",
      "../../assets/paket/Best/b11.jpg",
      "../../assets/paket/Best/b12.jpg",
    ],
    berkah: ["../../assets/paket/Berkah/b1-01.jpg", "../../assets/paket/Berkah/b2-01.jpg", "../../assets/paket/Berkah/b3-01.jpg"],
    hemat: ["../../assets/paket/Hemat/h1-01.jpg"],
    promo: ["../../assets/paket/Promo/p1-01.jpg", "../../assets/paket/Promo/p2-01.jpg"],
    vip: ["../../assets/paket/VIP/v1-01.jpg"],
    vvip: ["../../assets/paket/VVIP/vvip-01.jpg"],
    special: ["../../assets/paket/Special/s1-01.jpg"],
    all: [],
  };
  ...
  function renderPromos(category) {
    ...
    if (promos.length === 0) {
      ...
      promos.forEach((src, index) => {
        ...
        img.setAttribute("data-aos-delay", `${index * 200}`);
